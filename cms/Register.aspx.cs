    ...
    public partial class login : System.Web.UI.Page
    {
        ...
        protected void Login(object sender, EventArgs e)
        {
            try
            {
                ...
                DateTime birth_date1 = Convert.ToDateTime(birth_date.Text);
            ...
            catch (Exception)
            {
                ...
                Response.Write("Invalid data input.<br/>*Username must be unique.");
            }
        ...
        protected void profile_priv121(object sender, EventArgs e)
        {
            if (Session["user_id"] != null)
                ...
                Response.Write("Complete regestration first.");
        }
